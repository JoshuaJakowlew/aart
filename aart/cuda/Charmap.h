#ifndef CHARMAP_CUDA_H
#define CHARMAP_CUDA_H
...
#pragma endregion getters
		...
		/*template <typename F>
		[[nodiscard]] auto getCell(const T& color, F distance) const noexcept -> cv::cuda::GpuMat;*/
...
#pragma endregion members
	...
	//template <typename T>
	//template <typename F>
	//[[nodiscard]] auto Charmap<T>::getCell(const T& color, F distance) const noexcept -> cv::cuda::GpuMat
	//{
